                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="updateUser">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="role" v-model="user.role" class="form-control" name="role">
...
<script>
    export default {
        ...
        created() {
            let uri = `http://127.0.0.1:8000/api/edituser/${this.$route.params.id}`;
        ...
        methods: {
            updateUser() {
                let uri = `http://127.0.0.1:8000/api/updateuser/${this.$route.params.id}`;
